...
#include <stdio.h>
#include <stdlib.h>
//swap function: for swapping two integers values
...
<p>Now, things are going better. The key point is to first figure out that a program and a function are not the same thing. Therefore, the argument and parameter work differently within the program and the function. In the above code, calling the swap function doesn't change the value of the argument inside the program.</p>  
